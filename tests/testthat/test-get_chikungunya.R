test_that("get_chikungunya with mun_res and year works", {
  res <- get_chikungunya(agg = "mun_res", agg_time = "year", ano = 2016)
...
test_that("get_chikungunya with uf_res and year works", {
  res <- get_chikungunya(agg = "uf_res", agg_time = "year", ano = 2016)
...
test_that("get_chikungunya with mun_res and month works", {
  res <- get_chikungunya(agg = "mun_res", agg_time = "month", ano = 2016)
...
test_that("get_chikungunya with mun_res and week works", {
  res <- get_chikungunya(agg = "mun_res", agg_time = "week", ano = 2016)
...
test_that("get_chikungunya with sex filter and year works", {
  res0 <- get_chikungunya(agg = "mun_res", agg_time = "year", ano = 2016)
  res1 <- get_chikungunya(
    agg = "mun_res",
    sexo = "Masculino",
    agg_time = "year",
    ano = 2016
  )
  res2 <- get_chikungunya(
    agg = "mun_res",
    sexo = "Feminino",
    agg_time = "year",
    ano = 2016
  )
  res3 <- get_chikungunya(
    agg = "mun_res",
    sexo = "Ignorado",
    agg_time = "year",
    ano = 2016
