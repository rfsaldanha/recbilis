...
test_that("get_dengue with uf_res and year works", {
  res <- get_dengue(agg = "uf_res", agg_time = "year", ano = 2010)
...
test_that("get_dengue with sex filter and year works", {
  res0 <- get_dengue(agg = "mun_res", agg_time = "year", ano = 2010)
  res1 <- get_dengue(agg = "mun_res", sexo = "Masculino", agg_time = "year", ano = 2010)
  res2 <- get_dengue(agg = "mun_res", sexo = "Feminino", agg_time = "year", ano = 2010)
  res3 <- get_dengue(agg = "mun_res", sexo = "Ignorado", agg_time = "year", ano = 2010)
...
test_that("get_dengue with age filters and year works", {
  res0 <- get_dengue(agg = "mun_res", agg_time = "year", ano = 2010)
  res1 <- get_dengue(agg = "mun_res", idade_a = 10, agg_time = "year", ano = 2010)
  res2 <- get_dengue(agg = "mun_res", idade_b = 50, agg_time = "year", ano = 2010)
  res3 <- get_dengue(agg = "mun_res", idade_a = 10, idade_b = 50, agg_time = "year", ano = 2010)
