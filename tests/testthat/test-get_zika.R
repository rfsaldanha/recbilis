test_that("get_zika with mun_res and year works", {
  res <- get_zika(agg = "mun_res", agg_time = "year", ano = 2016)
...
test_that("get_zika with regsaude_449_res and year works", {
  res <- get_zika(agg = "regsaude_449_res", agg_time = "year", ano = 2016)
...
test_that("get_zika with uf_res and year works", {
  res <- get_zika(agg = "uf_res", agg_time = "year", ano = 2016)
...
test_that("get_zika with mun_res and month works", {
  res <- get_zika(agg = "mun_res", agg_time = "month", ano = 2016)
...
test_that("get_zika with mun_res and week works", {
  res <- get_zika(agg = "mun_res", agg_time = "week", ano = 2016)
...
test_that("get_zika with sex filter and year works", {
  res0 <- get_zika(agg = "mun_res", agg_time = "year", ano = 2016)
  res1 <- get_zika(
    agg = "mun_res",
    sexo = "Masculino",
    agg_time = "year",
...
test_that("get_zika with age filters and year works", {
  res0 <- get_zika(agg = "mun_res", agg_time = "year", ano = 2016)
  res1 <- get_zika(agg = "mun_res", idade_a = 10, agg_time = "year", ano = 2016)
  res2 <- get_zika(agg = "mun_res", idade_b = 50, agg_time = "year", ano = 2016)
  res3 <- get_zika(
    agg = "mun_res",
    idade_a = 10,
    idade_b = 50,
